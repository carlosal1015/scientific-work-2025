...
\begin{poster}{
    ...
    \headerbox{\bf\color{ctitle}Theoretical Analysis}{name=theorems,column=20,row=0,span=29}{
        ...
        \begin{theorem}[\colorbox{mathcolor}{\bfseries Existence and Uniqueness of Lane-Emden}~\cite{diGiovanni2019}]
            If $m\geq 1$ and
            \begin{math}
                g\in
                C^{1}
                \left(\mathbb{R}\times\left[0,\infty\right),\mathbb{R}\right)
            \end{math},
        ...
        \begin{theorem}[\colorbox{mathcolor2}{\bfseries Error bound}~\cite{Umesh2021}]
    ...
    \begin{equation*}
        ...
        L^{-1}Nu,
    \end{equation*}
    where $\Phi$ is chosen so that the solution $u$ satisfies the initial conditions.
    ...
    \headerbox{\bf\color{ctitle}Numerical solutions for Lane-Emden type equations}{name=results,column=0,row=0.46,span=100,boxpadding=0.45em}{
        ...
        \begin{minipage}[t]{0.32\paperwidth}
            ...
            \put(0,18){\makebox(0,0)[rt]{\includegraphics[width=3.6cm]{qrcode.pdf}}}
        \end{minipage}
