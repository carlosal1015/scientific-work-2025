\begin{frame}
    ...
    \begin{block}{Singular Cauchy problem of Lane-Emden type~\cite{Okunuga2012}}
    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.35\textwidth}
            \begin{figure}[ht!]
                \centering
                \includegraphics[width=.35\paperwidth]{gplots}
                \caption{Several.}
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}{Timeline}
    ...
    \begin{columns}[c]
        \begin{column}{0.48\textwidth}
            \begin{block}{Analytical solutions known}
                In general, there no exists analytical solutions for polytropic indices $n\neq 0,1,5$.
                % Pero para algunos casos específicos, es sencillo obtenerlos
                \begin{table}[ht!]
                    \centering
                    \begin{tabular}{c|c|c|c|c|c}
                        Index $n$ & Solution $\theta\left(\xi\right)$ & $p\left(r\right)$                              & $p_{c}\left(r\right)$        & $\rho\left(r\right)$                      & $M\left(r\right)$ \\
                        \hline
                        0         & $1-\frac{\xi^2}{6}$               & $p_{c}(1-\frac{r^2}{R^2})$                     & $\frac{2\pi}{3}G\rho_c^2R^2$ & $\textbf{Constante}$                      &                   \\
                        1         & $\frac{\sin\xi}{\xi}$             & $p_{c}(\frac{R}{\pi r}\sin{\pi\frac{r}{R}})^2$ & $\frac{2G}{\pi}\rho_c^2 R^2$ & $\rho_c\frac{R}{\pi r} \sin{\frac{r}{R}}$ &                   \\
                        5         & $\frac{1}{\sqrt{1+\xi^2/3}}$      &                                                &                              &                                           &
                    \end{tabular}
                \end{table}
            \end{block}
        \end{column}
        \begin{column}{0.48\textwidth}
            \begin{figure}[ht!]
                \centering
                \includegraphics[width=.35\paperwidth]{exacts}
                \caption{Several.}
            \end{figure}
        \end{column}
    \end{columns}
