\begin{frame}
    ...
    \alert{Lane-Emden equation}~(\cite{emden1907}~\Citeauthor{emden1907},~\citeyear{emden1907};
    \cite{lane1870}~\Citeauthor{lane1870},~\citeyear{lane1870}) has
    been used to describe the temperature variation in a star with
    hydrostatic equilibrium under a polytropic framework.
    Our goal is obtain numerical solutions Lane-Emden ODE when
    $n\neq 0,1,5$.\pause
    \begin{columns}[c]
        ...
        \begin{column}{0.58\textwidth}
            ...
            \begin{align}
                ...
                \tag{Mass equation}                     \\
                P\left(r\right)           & =
                K{\left[\rho\left(r\right)\right]}^{\frac{n+1}{n}}.
                \tag{Polytropic equation of state}
            \end{align}
            These set of equations leads to the \alert{Lane-Emden equation}
            \begin{equation*}
                \fcolorbox{bluUnits80}{yellow}{
                    \begin{math}\displaystyle
                        \frac{1}{r^{2}}
                        \diff*{
                            \left[
                                \frac{r^{2}}{\rho\left(r\right)}\diff{P\left(r\right)}{r}
                                \right]
                        }{r}=
                        -4\pi G
                        \rho\left(r\right).
