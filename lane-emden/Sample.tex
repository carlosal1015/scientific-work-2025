...
\title{Resolución numérica de una ecuación de tipo Lane-Emden}
...
El objetivo principal de este trabajo es realizar un estudio matemático detallado de la
ecuación de Lane-Emden, destacando sus propiedades estructurales y los métodos
utilizados para describir el comportamiento cualitativo de sus soluciones.  
