...
from sympy import Symbol, symbols, factorial, diff, simplify, Expr
from sympy.functions.elementary.trigonometric import sin
from sympy.functions.elementary.exponential import exp


def calculate_adomian_polynomials(f_expr: Expr, variables, num_terms: int):
    """
    ...
    for k in range(num_terms):
        ...
        derivative = diff(f_lamda, lamda, k)
...
if __name__ == "__main__":
    ...
    # calculate_adomian_polynomials(u**2, u, 6)
    # print("\n")
    # Reproduce the example N(u) = u * u'
    # calculate_adomian_polynomials(u * u_prime, [u, u_prime], 5)
    calculate_adomian_polynomials(u**5, u, 5)
    calculate_adomian_polynomials(u**3, u, 5)
